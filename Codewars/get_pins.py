...
# person, Robby the robber. We followed him to a secret warehouse, where
# we assume to find all the stolen stuff. The door to this warehouse is
# secured by an electronic combination lock. Unfortunately our spy
# isnt sure about the PIN he saw, when Robby entered it.
...
# Thats why we can try out all possible (*) variations.
...
# function, that returns an array (or a list in Java and C)
...
def get_pins(pin):
    ...
    return [''.join(i) for i in product(*[digits[i] for i in pin])]


# print([''.join(i) for i in (product(vers))])
print(get_pins("369"))


# [('8', ['5','7','8','9','0']),
# ('11',["11", "22", "44", "12", "21", "14", "41", "24", "42"])
# a = ["339","366","399","658","636","258","268","669","668","266","369","398",
# "256","296","259","368","638","396","238","356","659","639","666","359","336",
# "299","338","696","269","358","656","698","699","298","236","239"]

# print(sorted(a) == sorted(get_pins("369")))
